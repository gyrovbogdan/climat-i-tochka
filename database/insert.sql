...
Кондиционер Бирюса FORTUNA также имеет функцию iFeel, которая обеспечивает управление температурой и направлением потока воздуха в зависимости от расположения пользователя. Функция глубокого сна, турборежим, режим iFeel и другие настройки позволяют максимально настроить кондиционер на свои потребности.
Этот кондиционер оснащен скрытым дисплеем «Мираж» и антикоррозийным покрытием Blue Fin, обеспечивающим длительный срок службы кондиционера. Дополнительно, автоматическая самоочистка, функция обнаружения утечки хладагента и автоматическое оттаивание делают его безопасным и легким в использовании.
Кондиционер Бирюса FORTUNA - это отличный выбор для тех, кто хочет обеспечить комфорт в своем доме, особенно в условиях экстремальной жары или холода.', 'Настенный', 0),
/* 2 */
...
Функция "Рестарт":
Функция рестарта позволяет автоматически возобновить работу с прежними настройками. Перед повторным запуском, вызванным остановкой из-за перепадов питания, электронная система управления кондиционером восстанавливает заданные параметры, извлекая данные, хранящиеся во флеш-памяти устройства.
...
Удобный русифицированный пульт дистанционного управления обеспечивает легкое управление всеми функциями кондиционера, а функция 4D-Air flow автоматически качает жалюзи вверх-вниз и вправо-влево, обеспечивая равномерное распределение воздуха в помещении. Скрытый дисплей делает устройство более эстетичным, а золотистое антикоррозионное покрытие Golden Fin предотвращает коррозию и продлевает срок службы кондиционера.
Дополнительные функции, такие как функция самоочистки, обнаружение утечки хладагента, авторестарт при сбоях электроэнергии, запоминание положения жалюзи, режим TURBO, ночной режим, фильтр высокой плотности и дополнительный фильтр холодного катализа, обеспечивают максимальный комфорт и безопасность. Кондиционер также имеет функцию Follow Me, которая позволяет поддерживать оптимальную температуру в помещении, а автоматическое оттаивание и таймер обеспечивают более эффективную работу.', 'Настенный', 0),
/* 6 */
...
Кондиционер Бирюса FORTUNA также имеет функцию iFeel, которая обеспечивает управление температурой и направлением потока воздуха в зависимости от расположения пользователя. Функция глубокого сна, турборежим, режим iFeel и другие настройки позволяют максимально настроить кондиционер на свои потребности.
Этот кондиционер оснащен скрытым дисплеем «Мираж» и антикоррозийным покрытием Blue Fin, обеспечивающим длительный срок службы кондиционера. Дополнительно, автоматическая самоочистка, функция обнаружения утечки хладагента и автоматическое оттаивание делают его безопасным и легким в использовании.
Кондиционер Бирюса FORTUNA - это отличный выбор для тех, кто хочет обеспечить комфорт в своем доме, особенно в условиях экстремальной жары или холода.', 'Настенный', 1),
/* 8 */
...
/* 10 */ 
    ('Сплит-системы Бирюса серия Safiri INVERTER', '["/biryusa/biryusa-energy-0.jpg", "/biryusa/biryusa-energy-1.jpg", "/biryusa/biryusa-energy-2.jpg", "/biryusa/biryusa-energy-3.jpg", "/biryusa/biryusa-energy-4.jpg"]', 'Бирюса', 'Россия', 'Кондиционер Бирюса SAFARI - это высококачественное устройство с использованием передовых технологий для обеспечения комфортной атмосферы в помещении. Он оснащен мощным и эффективным компрессором GMCC-Toshiba, который обеспечивает быстрое охлаждение и обогрев воздуха. Кондиционер имеет 5 режимов работы, включая охлаждение, обогрев, осушение, вентиляцию и авто, что делает его идеальным для использования в любых условиях. Удобный русифицированный пульт дистанционного управления обеспечивает легкое управление всеми функциями кондиционера, а функция 4D-Air flow автоматически качает жалюзи вверх-вниз и вправо-влево, обеспечивая равномерное распределение воздуха в помещении. Скрытый дисплей делает устройство более эстетичным, а золотистое антикоррозионное покрытие Golden Fin предотвращает коррозию и продлевает срок службы кондиционера. Дополнительные функции, такие как функция самоочистки, обнаружение утечки хладагента, авторестарт при сбоях электроэнергии, запоминание положения жалюзи, режим TURBO, ночной режим, фильтр высокой плотности и дополнительный фильтр холодного катализа, обеспечивают максимальный комфорт и безопасность. Кондиционер также имеет функцию Follow Me, которая позволяет поддерживать оптимальную температуру в помещении, а автоматическое оттаивание и таймер обеспечивают более эффективную работу.', 'Настенный', 1);
...
VALUES
/* 11 */
  ('Сплит-системы Roland FAVORITE II on/off', '[""]', 'Roland', 'Япония', 'Системы кондиционирования ROLAND серии FAVORITE II представлены пятью моделями классических сплит-систем мощностью от 7 до 24 kBTU.
...
/* 12 */
  ('Сплит-системы Roland WIZARD on/off', '[""]', 'Roland', 'Япония', 'Кондиционеры ROLAND серии WIZARD сделаны с использованием передовых японских технологий, собственно что дает возможность обеспечивать их высочайшую продуктивность а также долговечность.
...
VALUES
/* 15 */
('Сплит-системы Midea серии PARAMOUNT On/off', '[""]', 'Midea', 'Китай', 'ОПИСАНИЕ', 'Настенный', 0),
/* 16 */
('Сплит-системы Midea серии PARAMOUNT Inverter', '[""]', 'Midea', 'Китай', 'ОПИСАНИЕ', 'Настенный', 0),
/* 17 */
('Сплит-системы Midea PRIMARY On/off', '[""]', 'Midea', 'Китай', 'ОПИСАНИЕ', 'Настенный', 0),
/* 18 */
('Сплит-системы Midea PRIMARY Inverter', '[""]', 'Midea', 'Китай', 'ОПИСАНИЕ', 'Настенный', 0),
/* 19 */
('Midea GAIA (MSCA) Inverter С ПРИТОКОМ СВЕЖЕГО ВОЗДУХА', '[""]', 'Midea', 'Китай', 'Описание...', 'Настенный', 1),
/* 20 */
('Сплит-системы Midea BREEZELESS (MSFA)  Inverter ', '[""]', 'Midea', 'Китай', 'ОПИСАНИЕ', 'Настенный', 0),
/* 21 */
('Сплит-системы Midea PERSONA (MSAG4) On/off', '[""]', 'Midea', 'Китай', 'ОПИСАНИЕ', 'Настенный', 0),
/* 22 */
('Сплит-системы Midea PERSONA (MSAG4) Inverter', '[""]', 'Midea', 'Китай', 'ОПИСАНИЕ', 'Настенный', 0),
/* 23 */
('МОБИЛЬНЫЕ КОНДИЦИОНЕРЫ (MPPDB) Midea On/off', '[""]', 'Midea', 'Китай', 'ОПИСАНИЕ', 'Мобильный', 0);
...
VALUES
/* 24 */
('Сплит-системы KENTATSU серия KANAMI (KSGA/KSRA) on/off', '[""]', 'Kentatsu', 'Япония', 'ОПИСАНИЕ', 'Настенный', 0),
/* 25 */
('Сплит-системы KENTATSU серия KANAMI (KSGA/KSRA) inverter', '[""]', 'Kentatsu', 'Япония', 'ОПИСАНИЕ', 'Настенный', 1),
/* 26 */
('Сплит-системы KENTATSU серия TIBA (KSGTI/KSRTI) on/off', '[""]', 'Kentatsu', 'Япония', 'ОПИСАНИЕ', 'Настенный', 0),
/* 27 */
('Сплит-системы KENTATSU серия TIBA INVERTER (KSGTI/KSRTI)', '[""]', 'Kentatsu', 'Япония', 'ОПИСАНИЕ', 'Настенный', 1),
/* 28 */
('Сплит-системы KENTATSU серия ICHI (KSGI/KSRI) on/off', '[""]', 'Kentatsu', 'Япония', 'ОПИСАНИЕ', 'Настенный', 0),
/* 29 */
('Сплит-системы KENTATSU серия Naomi (KSRN/KSGN) on/off', '[""]', 'Kentatsu', 'Япония', 'ОПИСАНИЕ', 'Настенный', 0),
/* 30 */
('Сплит-системы KENTATSU серия SEMPAI (KSGP/KSRP) inverter', '[""]', 'Kentatsu', 'Япония', 'ОПИСАНИЕ', 'Настенный', 1),
/* 31 */
('Сплит-системы KENTATSU серия OTARI (KSGY/KSRY) inverter', '[""]', 'Kentatsu', 'Япония', 'ОПИСАНИЕ', 'Настенный', 1),
/* 32 */
('Сплит-системы KENTATSU серия OMORI (KSGOM/KSROM) inverter', '[""]', 'Kentatsu', 'Япония', 'ОПИСАНИЕ', 'Настенный', 1);

INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(24, 'KSGA21HFAN1', '20', 25990, 19131, '2,34', '2,34', '0,71', '0,63', '729х292х200', NULL),
(24, 'KSGA26HFAN1', '21 - 25', 28490, 20871, '2,64', '2,78', '0,82', '0,77', '729х292х200', NULL),
(24, 'KSGA35HFAN1', '26 - 35', 36490, 26526, '3,52', '3,66', '1,1', '0,99', '802х295х200', NULL),
(24, 'KSGA53HFAN1', '36 - 50', 59490, 43491, '5,28', '5,28', '1,64', '1,46', '971х321х228', NULL),
(24, 'KSGA70HFAN1', '51 - 70', 75990, 55671, '7,03', '7,33', '2,19', '2,03', '1082х337х234', NULL);

INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(25, 'KSGA21HZRN1', '21 - 25', 36990, 26091, '2,20 (0,91~2,51)', '2,34 (0,70~2,93)', '0,69 (0,8-1,0)', '0,87 (0,10-1,25)', '729х292х200', NULL),
(25, 'KSGA26HZRN1', '26 - 35', 39490, 27831, '2,78 (1,17~3,22)', '3,22 (0,91~3,75)', '0,82 (0,10-1,25)', '0,73 (0,14-1,34)', '729х292х200', NULL),
(25, 'KSGA35HZRN1', '36 - 50', 44490, 31311, '3,37 (1,29~3,84)', '3,52 (1,06~4,04)', '1,00 (0,13-1,28)', '0,97 (0,18-1,22)', '729х292х200', NULL),
(25, 'KSGA53HZRN1', '51 - 70', 74490, 52626, '5,28 (3,39~5,90)', '5,57 (3,10~5,85)', '1,64 (0,14-2,36)', '1,54 (0,20-2,41)', '969х320х241', NULL),
(25, 'KSGA70HZRN1', '71 - 100', 95490, 67416, '7,03 (2,11~8,21)', '7,33 (1,55~8,21)', '2,34 (0,24-3,03)', '2,28 (0,26-3,14)', '1083х336х244', NULL);
...
INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(27, 'KSGTI21HZRN1 / KSRTI21HZRN1', '20', 39990, 28266, '2,14 (0,93~2,95)', '2,2 (0,82~3,37)', '0.59', '0.59', '708x185x260', 1),
(27, 'KSGTI26HZRN1 / KSRTI26HZRN1', '21 - 25', 43490, 30876, '2,64 (1,03~3,22)', '2,93 (0,82~3,37)', '0.68', '0.73', '708x185x260', 1),
(27, 'KSGTI35HZRN1 / KSRTI35HZRN1', '26 - 35', 47990, 33921, '3,52 (1,38~4,31)', '3,81 (1,07~4,38)', '0.99', '0.92', '783x185x260', 1),
(27, 'KSGTI50HZRN1 / KSRTI50HZRN1', '36 - 50', 81990, 57846, '5,28 (3,40~5,91)', '5,57 (3,11~5,87)', '1.35', '1.33', '943x246x333', 1),
(27, 'KSGTI70HZRN1 / KSRTI70HZRN1', '51 - 70', 104990, 73941, '7,03 (2,11~8,21)', '7,33 (1,55~8,21)', '1.79', '1.65', '943x246x333', 1),
(27, 'KSGTI100HZAN1 / KSRTI100HZAN1 R410', '51 - 70', 152990, 107871, '10,55 (2,65~11,60)', '10,55 (2,80~12,00)', '3', '2.78', '1078x246x333', 1);
...
(30, 'KSGY26HZRN1/KSRY26HZRN1', '21 - 25', 42200, 350, '2,64 (1,03~3,22)', '2,93 (0,82~3,37)', '0,69 (0,8-1,0)', '0,87 (0,10-1,25)', '729х292х200', NULL),
(30, 'KSGY35HZRN1/KSRY35HZRN1', '26 - 35', 45900, 380, '3,52 (1,38~4,31)', '3,81 (1,07~4,38)', '0,82 (0,10-1,25)', '0,73 (0,14-1,34)', '729х292х200', NULL),
(30, 'KSGY53HZRN1/KSRY53HZRN1', '36 - 50', 73300, 600, '5,28 (3,40~5,91)', '5,57 (3,11~5,87)', '1,00 (0,13-1,28)', '0,97 (0,18-1,22)', '729х292х200', NULL),
(30, 'KSGY70HZRN1/KSRY70HZRN1', '51 - 70', 94700, 785, '7,03 (2,11~8,21)', '7,33 (1,55~8,21)', '1,64 (0,14-2,36)', '1,54 (0,20-2,41)', '969х320х241', NULL),

(31, 'KSGOT26HZRN1/KSROT26HZRN1', '21 - 25', 58990, 41751, '2,70 (0,80~3,80)', '3,00 (0,90~4,25)', '0,69 (0,8-1,0)', '0,87 (0,10-1,25)', '744х256х185', NULL),
(31, 'KSGOT35HZRN1/KSROT35HZRN1', '26 - 35', 65490, 46101, '3,51 (0,90~4,40)', '3,81 (0,90~4,70)', '0,82 (0,10-1,25)', '0,73 (0,14-1,34)', '819х256х185', NULL),
(31, 'KSGOT50HZRN1/KSROT50HZRN1', '36 - 50', 95490, 67416, '5,2 (1,00~6,10)', '5,60 (1,10~6,60)', '1,00 (0,13-1,28)', '0,97 (0,18-1,22)', '849х289х210', NULL),
(31, 'KSGOT70HZRN1/KSROT70HZRN1', '51 - 70', 125490, 88731, '7,10 (2,00~8,85)', '7,80 (1,80~9,45)', '1,64 (0,14-2,36)', '1,54 (0,20-2,41)', '1012х307х220', NULL);

INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(32, 'KSGOM26HZRN1/KSROM26HZRN1', '20', 66490, 46971, '2,64 (1,23~3,29)', '2,93 (0,85~3,72)', '0,69 (0,8-1,0)', '0,87 (0,10-1,25)', '744х256х185', NULL),
(32, 'KSGOM35HZRN1/KSROM35HZRN1', '21 - 25', 69990, 49581, '3,52 (1,32~4,30)', '3,81 (0,88~4,40)', '0,82 (0,10-1,25)', '0,73 (0,14-1,34)', '819х256х185', NULL);
...
VALUES
/* 33 */
('Сплит-системы DAICHI серия EVEREST On/Off', '[""]', 'Daichi', 'Япония', 'ОПИСАНИЕ', 'Настенный', 0),
/* 34 */
('Сплит-системы DAICHI серия ICE On/Off', '[""]', 'Daichi', 'Япония', 'ОПИСАНИЕ', 'Настенный', 0),
/* 35 */
('Сплит-системы DAICHI серия O2 inverter R-32', '[""]', 'Daichi', 'Япония', 'ОПИСАНИЕ', 'Настенный', 1),
/* 36 */
('Сплит-системы DAICHI серия ICE inverter', '[""]', 'Daichi', 'Япония', 'ОПИСАНИЕ', 'Настенный', 1),
/* 37 */
('Сплит-системы DAICHI серия дизайнерская CARBON On/Off', '[""]', 'Daichi', 'Япония', 'ОПИСАНИЕ', 'Настенный', 0),
/* 38 */
('Сплит-системы DAICHI серия AIR On/Off', '[""]', 'Daichi', 'Япония', 'ОПИСАНИЕ', 'Настенный', 0),
/* 39 */
('Сплит-системы DAICHI серия AIR inverter', '[""]', 'Daichi', 'Япония', 'ОПИСАНИЕ', 'Настенный', 1),
/* 40 */
('Сплит-системы DAICHI серия CARBON inverter', '[""]', 'Daichi', 'Япония', 'ОПИСАНИЕ', 'Настенный', 1),
/* 41 */
('Сплит-системы DAICHI серия EVOLUTION (обогрев до -30°C) inverter', '[""]', 'Daichi', 'Япония', 'ОПИСАНИЕ', 'Настенный', 1),
/* 42 */
('Сплит-системы DAICHI Тепловой насос серии SIBERIA (обогрев до -25°C) inverter ', '[""]', 'Daichi', 'Япония', 'ОПИСАНИЕ', 'Настенный', 1);

 -- DAICHI серия EVEREST On\Off
INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
  (33, 'DA20EVQ1-1-DF20EV1-1', '20', 23490, 18990, 2.05, 2.26, '', '', '798x25x185', 0),
  (33, 'DA25EVQ1-1 -DF25EV1-1', '21 - 25', 25990, 20990, 2.64, 2.86, '', '', '798x25x185', 0),
  (33, 'DA35EVQ1-1-DF35EV1-1', '26 - 35', 34990, 28490, 3.52, 3.77, '', '', '773x250x185', 0),
  (33, 'DA50EVQ1-1-DF50EV1-1', '36 - 50', 59990, 48490, 5.28, 5.42, '', '', '849x289x215', 0),
  (33, 'DA70EVQ1-1-DF70EV1-1', '51 - 70', 73990, 59990, 7.03, 7.29, '', '', '970x300x225', 0);
  
-- DAICHI серия ICE On\Off
INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(34, 'ICE20AVQ1-1 / ICE20FV1-1', '20', 29990, 21306, 2.25, 2.35,'', '', '698x25x185', 0),
(34, 'ICE25AVQ1-1 / ICE25FV1-1', '21 - 25', 31990, 22611, 2.55, 2.65, '', '', '698x25x185', 0),
(34, 'ICE35AVQ1-1 / ICE35FV1-1', '26 - 35', 41990, 29571, 3.25, 3.47, '', '', '773x250x185', 0),
(34, 'ICE50AVQ1-1 / ICE50FV1-1', '36 - 50', 70016, 50016, 4.85, 5.38, '', '', '849x289x215', 0),
(34, 'ICE60AVQ1-1 / ICE60FV1-1', '51 - 70', 87196, 62196, 6.15, 6.79, '', '', '970x300x225', 0),
(34, 'ICE80AVQ1-1 / ICE80FV1-1', '51 - 70', 122490, 86556, 8.59, 9.21, '', '', '80x325x254', 0),
(34, 'ICE95AVQ1 / ICE95FV1-1', '71 - 100', 150490, 106131, 9.59, 9.81, '', '', '80x325x245', 0);

-- DAICHI серия O2 inverter R-32
INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(35, 'O220AVQS1R-1-O220FVS1R-1', '20', 37490, 27396, 2.35, 2.50, '', '', '790×275×200', 1),
(35, 'O225AVQS1R-1-O225FVS1R-1', '21 - 25', 40490, 29571, 2.65, 2.85, '', '', '790×275×200', 1),
(35, 'O235AVQS1R-1-O235FVS1R-1', '26 - 35', 44990, 33051, 3.50, 3.50, '', '', '790×275×200', 1),
(35, 'O250AVQS1R-1-O250FVS1R-1', '36 - 50', 57411, 42411, 4.60, 5.20, '', '', '970×300×224', 1),
(35, 'O260AVQS1R-1-O260FVS1R-1', '51 - 70', 72636, 57636, 6.16, 6.20, '', '', '970×300×224', 1);

-- DAICHI серия ICE inverter
INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(36, 'ICE20AVQS1R - ICE20FVS1R', '20', 37490, 27396, 2.35, 2.50, '', '', '698x25x185', 1),
(36, 'ICE25AVQS1R - ICE25FVS1R', '21 - 25', 40490, 29571, 2.65, 2.85, '', '', '698x25x185', 1),
(36, 'ICE35AVQS1R - ICE35FVS1R', '26 - 35', 44990, 33051, 3.50, 3.50, '', '', '773x250x185', 1),
(36, 'ICE50AVQS1R -ICE50FVS1R', '36 - 50', 57411, 42411, 4.60, 5.20, '', '', '849x289x215', 1),
(36, 'ICE70AVQS1R -ICE70FVS1R', '51 - 70', 72636, 57636, 6.16, 6.20, '', '', '970x300x225', 1);

-- DAICHI серия дизайнерская CARBON On\Off
INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(37, 'DA20DVQ1-B1 /DF20DV1-1', '20', 22611, NULL, 2.05, 2.26, '', '', '798x25x185', 0),
(37, 'DA25DVQ1-B1 /DF25DV1-1', '21 - 25', 23916, NULL, 2.64, 2.86, '', '', '798x25x185', 0),
(37, 'DA35DVQ1-B1 /DF35DV1-1', '26 - 35', 30441, NULL, 3.52, 3.77, '', '', '773x250x185', 0),
(37, 'DA50DVQ1-B1 /DF50DV1-1', '36 - 50', 48711, NULL, 5.28, 5.42, '', '', '849x289x215', 0),
(37, 'DA70DVQ1-B1 /DF70DV1-1', '51 - 70', 60891, NULL, 7.03, 7.29, '', '', '970x300x225', 0);


-- Сплит-системы DAICHI серия AIR On\Off завода TCL
INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(38, 'AIR20AVQ1-AIR20FV1', '20', 22490, 16521, 2.22, 2.69, '', '', '713x250x185', 0),
(38, 'AIR25AVQ1-AIR25FV1', '21 - 25', 24990, 18261, 2.64, 2.78, '', '', '713x250x185', 0),
(38, 'AIR35AVQ1-AIR35FV1', '26 - 35', 33890, 24786, 3.52, 3.66, '', '', '773x250x185', 0),
(38, 'AIR50AVQ1 AIR50FV1', '36 - 50', 57490, 42186, 5.28, 5.42, '', '', '849x289x215', 0),
(38, 'AIR70AVQ1 -AIR70FV1', '51 - 70', 71490, 52191, 7.03, 7.18, '', '', '970x300x225', 0);

-- Сплит-системы DAICHI серия AIR inverter завода TCL
INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(39, 'AIR25AVQS1R /AIR25FVS1R', '20', 39490, 28701, 2.60, 2.63, '', '', '713x270x195', 1),
(39, 'AIR35AVQS1R /AIR35FVS1R', '21 - 25', 43990, 32181, 3.40, 3.43, '', '', '790x275x200', 1),
(39, 'AIR50AVQS1R /AIR50FVS1R', '26 - 35', 74990, 54801, 5.10, 5.13, '', '', '790x275x200', 1),
(39, 'AIR60AVQS1R /AIR60FVS1R', '36 - 50', 99990, 73071, 6.80, 7.05, '', '', '970x300x224', 1);

-- Сплит-системы DAICHI серия CARBON inverter завода TCL
INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(40, 'DA25DVQS1R-B / DF25DVS1R', '20', 49490, 34791, 2.60, 2.61, '', '', '713x270x195', 1),
(40, 'DA35DVQS1R-B / DF35DVS1R', '21 - 25', 53490, 37836, 3.40, 3.42, '', '', '790x275x200', 1),
(40, 'DA50DVQS1R-B / DF50DVS1R', '26 - 35', 87990, 62196, 5.10, 5.10, '', '', '790x275x200', 1),
(40, 'DA70DVQS1R-B / DF70DVS1R', '36 - 50', 115990, 81771, 6.81, 6.87, '', '', '970x300x224', 1);

-- Сплит-системы DAICHI серия EVOLUTION (обогрев до -30°C) inverter завода GREE
INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(41, 'EVO25AVQS1R -EVO25FVS1R', '20', 108490, 76551, 2.70, 3.50, '', '', '790x275x200', 1),
(41, 'EVO35AVQS1R - EVO35FVS1R', '21 - 25', 114490, 80901, 3.53, 4.20, '', '', '790x275x200', 1),
(41, 'EVO50AVQS1R - EVO50FVS1R', '26 - 35', 145490, 102651, 5.30, 6.20, '', '', '970x300x224', 1),
(41, 'EVO70AVQS1R - EVO70FVS1R', '36 - 50', 161990, 114396, 7.03, 7.03, '', '', '970x300x224', 1);

-- Сплит-системы DAICHI Тепловой насос серии SIBERIA (обогрев до -25°C) inverter завода GREE
INSERT INTO conditioner_models (conditioner_id, name, area, price, promo_price, performance_cold, performance_warm, power_input_cold, power_input_warm, indoor_sizes, `wi-fi`)
VALUES
(42, 'SIB25AVQS1R - SIB25FVS1R', '20', 55990, 39576, 2.70, 3.00, '', '', '790x275x200', 1),
(42, 'SIB35AVQS1R - SIB35FVS1R', '21 - 25', 61990, 43926, 3.51, 3.81, '', '', '790x275x200', 1),
(42, 'SIB50AVQS1R - SIB50FVS1R', '26 - 35', 93490, 66111, 5.20, 5.60, '', '', '970x300x224', 1),
(42, 'SIB70AVQS1R - SIB70FVS1R', '36 - 50', 123990, 87426, 7.10, 7.80, '', '', '970x300x224', 1);
