    ...
    <footer class="py-3 my-4 border-top">
        <div class="d-flex flex-wrap justify-content-between">
            <div class="col-md-4 d-flex">
                ...
                <a class="mb-3 mb-md-0 pt-1 text-body-secondary" href="tel:{{ $phone }}">{{ $phone }}</a>

            </div>

            <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">

                <li class="ms-3"><a class="text-body-secondary" href="{{ $vk }}"><svg
                ...
                <li class="ms-3"><a class="text-body-secondary" href="{{ $whatsApp }}"><svg
                ...
                <li class="ms-3"><a class="text-body-secondary" href="{{ $telegram }}"><svg
                            xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
