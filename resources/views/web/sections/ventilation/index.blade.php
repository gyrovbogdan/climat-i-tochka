...
@section('meta')
    @include('web.layout.partials.meta', [
        'description' => 'Вентиляция в Симферополе: ✓ Большой выбор систем вентиляции ✓ Монтаж ✓ Доставка ✓ Гарантия ✓ Приточная вентиляция ✓
                                Магазин вентиляции. Купить вентиляцию в Симферополе по выгодным ценам.',
