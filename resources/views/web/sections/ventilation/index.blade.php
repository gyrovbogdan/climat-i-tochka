...
@section('content')
    <div class="container">
        <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5 fw-semibold">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="accordion-body">
                        ...
                        наших специалистов по тел. {{ $contacts[0]['data'] }}.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                ...
                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                    ...
                    <div class="accordion-body">
                        ...
                        поэтому подобная работа должна быть выполнена опытными специалистами. Для расчета стоимости и выезда
                        инженера на объект оставьте заявку или перезвоните по тел {{ $contacts[0]['data'] }}.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                ...
                <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                    data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        Для обеспечения нормальной циркуляции и обмена воздушных масс необходима установка вытяжных систем
        ...
        <section>
            <p>
                ...
                СНиП (Строительные нормы и правила) регламентируют кратность воздухообмена для различных типов помещений.
                Кратность воздухообмена - это число, которое показывает, сколько раз в час воздух в помещении должен быть
            ...
            <button type="button" class="btn btn-primary my-4">Расчитать стоимость монтажа вентиляции бесплатно</button>
        </section>
