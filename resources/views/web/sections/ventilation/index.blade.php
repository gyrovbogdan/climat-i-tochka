            ...
            <div class="col">
                <div class="row row-cols-1 row-cols-lg-2 g-4">
                    <div class="col d-flex flex-column gap-2">
                        ...
                        <h1 class="fw-semibold mb-0 text-body-emphasis h4">Оставьте заявку</h1>
                    ...
                    <div class="col d-flex flex-column gap-2">
                        ...
                        <h1 class="fw-semibold mb-0 text-body-emphasis h4">Получите бесплатный расчет</h1>
                    ...
                    <div class="col d-flex flex-column gap-2">
                        ...
                        <h1 class="fw-semibold mb-0 text-body-emphasis h4">Изготовление фасонных элементов</h1>
                    ...
                    <div class="col d-flex flex-column gap-2">
                        ...
                        <h1 class="fw-semibold mb-0 text-body-emphasis h4">Выполнение монтажных работ</h1>
