...
@section('meta')
    @include('web.layout.partials.meta', [
        'description' =>
            'Климат и точка крым. Продажа и установка кондиционеров в Симферополе. Большой выбор кондиционеров по доступным ценам. Бесплатная доставка и установка. Опытные монтажники. Гарантия на все работы.',
