...
@section('meta')
    @include('web.layout.partials.meta', [
        'description' =>
            'Продажа и установка кондиционеров в Симферополе. Большой выбор кондиционеров по доступным ценам. Бесплатная доставка и установка. Опытные монтажники. Гарантия на все работы.',
